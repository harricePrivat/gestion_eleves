...
class _AccueilState extends State<Accueil> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(title:  Text("Gestion des eleves - MIT",style: theme.textTheme.bodyMedium,),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items:const  [
        BottomNavigationBarItem(icon:Icon(Icons.school,),label: "Eleves"),
        BottomNavigationBarItem(icon:Icon(Icons.account_box,),label: "Mon Compte")
      ]),
    );
  }
}